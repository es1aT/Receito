    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            try:
                ...
                出力例は以下の通りです
                日付:yyy/MM/dd
                商品1の商品名,商品1の個数,商品1の金額
                商品2の商品名,商品2の個数,商品2の金額
                商品3の商品名,商品3の個数,商品3の金額
                """
                ...
                return render_template('result.html', extracted_text=text, generated_response=generated_text)
            except Exception as e:
                print(f"Error: {e}")
